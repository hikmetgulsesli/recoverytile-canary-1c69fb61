...
- RecoveryTile Canary turns the user's request into a directly usable web workflow. The first experience must be the actual web product behavior, not a marketing landing page or placeholder demo.
- - FR-001: Build a tiny single-page utility called RecoveryTile Canary. It should show three compact recovery tiles, let the user cycle each tile between ok/warn/down, persist state in localStorage, expose window.app with getState and reset methods, and include visible reset and export controls. Keep it static HTML/CSS…
...
- Record Operations - RecoveryTile Canary
- Record Editor - RecoveryTile Canary
- Empty and Error Recovery - RecoveryTile Canary

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Record Operations - RecoveryTile Canary
...
SCREEN_SPEC_2:
- exact_screen_title: Record Editor - RecoveryTile Canary
...
SCREEN_SPEC_3:
- exact_screen_title: Empty and Error Recovery - RecoveryTile Canary
